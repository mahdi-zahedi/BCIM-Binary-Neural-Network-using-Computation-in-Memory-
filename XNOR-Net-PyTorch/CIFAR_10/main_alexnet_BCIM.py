...
def test(model, epoch):
	...
	for data, target in testloader:
		...
		p1 = model.module.bin_conv2_1(x[:,0:20,:,:])
		p2 = model.module.bin_conv2_2(x[:,20:40,:,:])
		p3 = model.module.bin_conv2_3(x[:,40:60,:,:])
		p4 = model.module.bin_conv2_4(x[:,60:80,:,:])
		p5 = model.module.bin_conv2_5(x[:,80:96,:,:])		
		#x = p1.sign() + p2.sign() + p3.sign() + p4.sign() + p5.sign()
		x = p1 + p2 + p3 + p4 + p5
		
		#plot1 = sns.displot(torch.flatten(p1).cpu().detach().numpy(), binwidth=3)
		#plot2 = sns.displot(torch.flatten(p2).cpu().detach().numpy(), binwidth=3)
		#plot3 = sns.displot(torch.flatten(p3).cpu().detach().numpy(),  binwidth=3)
		#plot4 = sns.displot(torch.flatten(p4).cpu().detach().numpy(), binwidth=3)
		#plot5  = sns.displot(torch.flatten(p5).cpu().detach().numpy(), binwidth=3)
		#plot6  = sns.displot(torch.flatten(x).cpu().detach().numpy(), binwidth=3)
		...
		p1 = model.module.bin_conv3_1(x[:,0:56,:,:])
		p2 = model.module.bin_conv3_2(x[:,56:112,:,:])
		p3 = model.module.bin_conv3_3(x[:,112:168,:,:])
		p4 = model.module.bin_conv3_4(x[:,168:224,:,:])
		p5 = model.module.bin_conv3_5(x[:,224:257,:,:])
		x = p1.sign() + p2.sign() + p3.sign() + p4.sign() + p5.sign()
		#x = p1 + p2 + p3 + p4 + p5
		
		
		p1 = model.module.bin_conv4_1(x[:,0:56,:,:])
		p2 = model.module.bin_conv4_2(x[:,56:112,:,:])
		p3 = model.module.bin_conv4_3(x[:,112:168,:,:])
		p4 = model.module.bin_conv4_4(x[:,168:224,:,:])
		p5 = model.module.bin_conv4_5(x[:,224:280,:,:])
		p6 = model.module.bin_conv4_6(x[:,280:336,:,:])
		p7 = model.module.bin_conv4_7(x[:,336:384,:,:])
		x = p1.sign() + p2.sign() + p3.sign() + p4.sign() + p5.sign() + p6.sign() + p7.sign()
		#x = p1 + p2 + p3 + p4 + p5 + p6 + p7
		
		
		p1 = model.module.bin_conv5_1(x[:,0:56,:,:])
		p2 = model.module.bin_conv5_2(x[:,56:112,:,:])
		p3 = model.module.bin_conv5_3(x[:,112:168,:,:])
		p4 = model.module.bin_conv5_4(x[:,168:224,:,:])
		p5 = model.module.bin_conv5_5(x[:,224:280,:,:])
		p6 = model.module.bin_conv5_6(x[:,280:336,:,:])
		p7 = model.module.bin_conv5_7(x[:,336:384,:,:])
		x = p1.sign() + p2.sign() + p3.sign() + p4.sign() + p5.sign() + p6.sign() + p7.sign()
		#x = p1 + p2 + p3 + p4 + p5 + p6 + p7
		...
		p1 = model.module.bin_conv6_1(x[:,0:512])
		p2 = model.module.bin_conv6_2(x[:,512:1024])
		p3 = model.module.bin_conv6_3(x[:,1024:1536])
		p4 = model.module.bin_conv6_4(x[:,1536:2048])
		p5 = model.module.bin_conv6_5(x[:,2048:2560])
		p6 = model.module.bin_conv6_6(x[:,2560:3072])
		p7 = model.module.bin_conv6_7(x[:,3072:3584])
		p8 = model.module.bin_conv6_8(x[:,3584:4096])
		p9 = model.module.bin_conv6_9(x[:,4096:4608])
		p10 = model.module.bin_conv6_10(x[:,4608:5120])
		p11 = model.module.bin_conv6_11(x[:,5120:5632])
		p12 = model.module.bin_conv6_12(x[:,5632:6144])
		p13 = model.module.bin_conv6_13(x[:,6144:6656])
		p14 = model.module.bin_conv6_14(x[:,6656:7168])
		p15 = model.module.bin_conv6_15(x[:,7168:7680])
		p16 = model.module.bin_conv6_16(x[:,7680:8192])
		p17 = model.module.bin_conv6_17(x[:,8192:8704])
		p18 = model.module.bin_conv6_18(x[:,8704:9216])
		...
		p1 = model.module.bin_conv7_1(x[:,0:512])
		p2 = model.module.bin_conv7_2(x[:,512:1024])
		p3 = model.module.bin_conv7_3(x[:,1024:1536])
		p4 = model.module.bin_conv7_4(x[:,1536:2048])
		p5 = model.module.bin_conv7_5(x[:,2048:2560])
		p6 = model.module.bin_conv7_6(x[:,2560:3072])
		p7 = model.module.bin_conv7_7(x[:,3072:3584])
		p8 = model.module.bin_conv7_8(x[:,3584:4096])
		x = p1.sign() + p2.sign() + p3.sign() + p4.sign() + p5.sign() + p6.sign() + p7.sign() + p8.sign()
