...
class MLP_M(nn.Module):
    def __init__(self):
        ...
        self.bin_FC2_1 = BinConv2d(392, 1000, Linear=True, previous_conv=True, size=1*1)
        self.bin_FC2_2 = BinConv2d(392, 1000, Linear=True, previous_conv=True, size=1*1)
        
        self.bin_FC3_1 = BinConv2d(500, 500, Linear=True, previous_conv=False, size=1*1)
        self.bin_FC3_2 = BinConv2d(500, 500, Linear=True, previous_conv=False, size=1*1)
        self.bin_FC4 = BinConv2d(500, 250, Linear=True, previous_conv=False, size=1*1)
