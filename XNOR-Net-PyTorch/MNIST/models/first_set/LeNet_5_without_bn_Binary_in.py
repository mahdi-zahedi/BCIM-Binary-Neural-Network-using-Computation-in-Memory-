...
class LeNet_5_without_bn_Binary_in(nn.Module):
    def __init__(self):
        super(LeNet_5_without_bn_Binary_in, self).__init__()
        ...
        self.bin_ip2 = BinConv2d(500,10, Linear=True, previous_conv=False)
